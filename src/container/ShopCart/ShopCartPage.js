...
function ShopCartPage(props) {
  ...
  return (
    <section className="cart_area">
      ...
      {dataCart && dataCart.length > 0 ? ( <div className="container">
      ...
      <VoucherModal closeModalFromVoucherItem={closeModalFromVoucherItem} price={price + +priceShip} isOpenModal={isOpenModal} closeModal={closeModal} id={user && user.id} />
