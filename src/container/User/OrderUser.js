                  ...
                  <div className="box-list-order">
                    <div className="content-top">
                      <div className="content-left">
                        ...
                        <span className="label-name-shop">Ashion shop</span>
                          ...
                          <div className="content-center">
                            <div className="box-item-order">
                              ...
                              <div className="box-des">
                                ...
                                <span className="type">
                                  Phân loại hàng: {item.productDetail.nameDetail} | {item.productDetailSize.sizeData.value}
                                </span>
                    ...
                    <div className="up">
                      ...
                      <span className="name">
                        {item && item.voucherData && item.voucherData.id
                          ? CommonUtils.formatter.format(totalPriceDiscount(price, item.voucherData) + item.typeShipData.price)
