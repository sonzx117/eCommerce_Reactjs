...
function DetailUserPage(props) {
  ...
  return (
    <div className="container rounded bg-white mt-5 mb-5">
      <div className="row">
        <div className="col-md-12 bg-white shadow-lg">
          <div className="col-md-12">
            <div className="d-flex flex-column align-items-center text-center p-3">
              ...
              <div className="box-email-verify">
                ...
                {inputValues.isActiveEmail === 0 && <i style={{ color: '#dc0707' }} className="fas fa-times-circle"></i>}
                {inputValues.isActiveEmail === 1 && <i style={{ color: 'green' }} className="fas fa-check-circle"></i>}
              </div>
          ...
          <div className="p-3 py-5">
            ...
            <div className="row mt-2">
              <div className="col-md-6">
                ...
                <input name="firstName" onChange={(event) => handleOnChange(event)} value={inputValues.firstName} type="text" className="form-control" />
              </div>
              <div className="col-md-6">
                <label className="labels">Tên</label>
                <input name="lastName" onChange={(event) => handleOnChange(event)} value={inputValues.lastName} type="text" className="form-control" />
              </div>
            </div>
            <div className="row mt-3">
              <div className="col-md-12">
                <label className="labels">Số điện thoại</label>
                <input name="phonenumber" onChange={(event) => handleOnChange(event)} type="text" className="form-control" value={inputValues.phonenumber} />
              </div>
              {/* <div className="col-md-12">
                <label className="labels">Địa chỉ</label>
                <input name="address" onChange={(event) => handleOnChange(event)} type="text" className="form-control" value={inputValues.address} />
              </div> */}
            </div>
            <div className="row mt-3">
              <div className="col-md-6">
              ...
              <div className="col-md-6">
                <label className="labels">Ngày sinh</label> <DatePicker className="form-control" onChange={handleOnChangeDatePicker} value={birthday} />
              </div>
            </div>
            <div className="row mt-2">
              <div className="col-md-3">
                <label className="labels me-2">Chọn ảnh</label>
      ...
      {inputValues.isOpen === true && <Lightbox mainSrc={inputValues.imageReview} onCloseRequest={() => setInputValues({ ...inputValues, ['isOpen']: false })} />}
    </div>
  );
}
