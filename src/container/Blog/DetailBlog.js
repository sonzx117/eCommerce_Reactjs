...
import { getDetailBlogByIdService, getAllCategoryBlogService, createNewcommentService, getAllcommentByBlogIdService, getFeatureBlog } from '../../services/userService';
...
function DetailBlog(props) {
  ...
  return (
    <>
      <section class="banner_area bg-bannerblog">
              ...
              <div className="single-post">
                ...
                <div className="blog_details">
                  ...
                  <ul className="blog-info-link mt-3 mb-4">
                    <li>
                      <a href="#">
                        <i className="ti-user" /> {dataBlog.userData && dataBlog.userData.firstName + ' ' + dataBlog.userData.lastName}
                      </a>
                    </li>
                    <li>
                      <a href="#">
                ...
                {dataComment &&
                  ...
                  dataComment.map((item, index) => {
                    if (item.user) {
                      ...
                      return <CommentBlog img={item.user.image} name={name} content={item.content} key={index} date={moment(item.createdAt).fromNow()} />;
                    }
                  })}
              </div>
