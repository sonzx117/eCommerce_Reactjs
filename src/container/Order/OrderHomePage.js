  ...
  return (
    <>
      <div className="wrap-order">
                ...
                <>
                  <div className="content-left">
                    <span>
                      ...
                      {dataAddressUser && dataAddressUser.length > 0 && dataAddressUser[0].shipPhonenumber})
                    </span>
                  </div>
                  <div className="content-center">
                    <span>{dataAddressUser && dataAddressUser.length > 0 && dataAddressUser[stt].shipAdress}</span>
                  </div>
                </>
              ) : (
                <div>
              ...
              <div className="box-shopcart-bottom">
                <div className="content-left">
                  <div className="wrap-voucher">
                    ...
                    <span className="name-easier">Ashion voucher</span>
                    <span onClick={() => handleOpenModal()} className="choose-voucher">
                      Chọn Mã
                    </span>
                    {dataVoucher && dataVoucher.voucherData && <span className="choose-voucher">Mã voucher: {dataVoucher.voucherData.codeVoucher}</span>}
                  </div>
        ...
        <div className="wrap-payment">
          <div className="content-top">
            <div style={{ display: 'flex', gap: '10px' }}>
              ...
              <div onClick={() => setactiveTypePayment(1)} className={activeTypePayment === 1 ? 'box-type-payment active' : 'box-type-payment'}>
                Thanh toán Online
              </div>

              <div onClick={() => setactiveTypePayment(0)} className={activeTypePayment === 0 ? 'box-type-payment active' : 'box-type-payment'}>
                Thanh toán khi nhận hàng
              </div>
            </div>
            {activeTypePayment != 0 && (
              <div className="box-payment">
                <div onClick={() => setactiveTypeOnlPayment(1)} className={activeTypeOnlPayment === 1 ? 'box-type-payment activeOnl' : 'box-type-payment'}>
                  Thanh toán PAYPAL
                </div>
                <div onClick={() => setactiveTypeOnlPayment(2)} className={activeTypeOnlPayment === 2 ? 'box-type-payment activeOnl' : 'box-type-payment'}>
                  Thanh toán VNPAY
                </div>
              </div>
            )}
        ...
        <VoucherModal closeModalFromVoucherItem={closeModalFromVoucherItem} price={price + +priceShip} isOpenModal={isOpenModal} closeModal={closeModal} id={userId} />
