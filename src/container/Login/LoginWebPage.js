...
import { handleLoginService,handleGoogleLoginService, checkPhonenumberEmail, createNewUser } from '../../services/userService';
import Otp from './Otp';
...
const LoginWebPage = () => {
  ...
  let handleResponse = (res) => {
    if (res && res.errCode === 0) {
        ...
        const roleMessage = res.user.roleId === "R1" || res.user.roleId === "R4" ? "Admin" : "User";
        toast.success(`Successful login. Welcome ${roleMessage}!`);
  ...
  let handleLoginSocial = async (email) => {
    ...
    let res = await handleGoogleLoginService({email:email})
    handleResponse(res);
  };
                  ...
                  <div className="login form-peice ">
                    <form className="login-form">
                      ...
                      {/* <FacebookLoginButton
                        ...
                        iconSize="25px"
                        style={{ width: '300px', height: '40px', fontSize: '16px', marginTop: '40px', marginBottom: '10px' }}
                  ...
                  <div className="signup form-peice switched">
                    <form className="signup-form">
                      ...
                      <div className="form-group">
                        ...
                        <input type="text" name="phonenumber" onChange={(event) => handleOnChange(event)} id="phone" className="phonenumber" />
                        <span className="error" />
                      </div>
                      <div className="form-group">
