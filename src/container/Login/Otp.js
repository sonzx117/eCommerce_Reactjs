    ...
    <>
      <div className="container d-flex justify-content-center align-items-center container_Otp">
        <div className="card text-center mb-3">
          ...
          <input ref={el => inputRefs.current[0] = el} value={inputValues.so1} name="so1" onChange={(event) => {handleOnChange(event);if (event.target.value) inputRefs.current[1].focus();}} 
          type="text" 
          className="m-1 text-center form-control rounded" 
          maxLength={1} />
          <input ref={el => inputRefs.current[1] = el} value={inputValues.so2} name="so2" onChange={(event) => { handleOnChange(event); if (event.target.value) inputRefs.current[2].focus(); }}
          type="text" 
          className="m-1 text-center form-control rounded" 
              maxLength={1} />
          <input ref={el => inputRefs.current[2] = el} value={inputValues.so3} name="so3" onChange={(event) => { handleOnChange(event); if (event.target.value) inputRefs.current[3].focus(); }}
          type="text" 
          className="m-1 text-center form-control rounded" 
              maxLength={1} />
          <input ref={el => inputRefs.current[3] = el} value={inputValues.so4} name="so4" onChange={(event) => { handleOnChange(event); if (event.target.value) inputRefs.current[4].focus(); }}
          type="text" 
          className="m-1 text-center form-control rounded" 
              maxLength={1} />
          <input ref={el => inputRefs.current[4] = el} value={inputValues.so5} name="so5" onChange={(event) => { handleOnChange(event); if (event.target.value) inputRefs.current[5].focus(); }}
          type="text" 
          className="m-1 text-center form-control rounded" 
              maxLength={1} />
          <input ref={el => inputRefs.current[5] = el} value={inputValues.so6} name="so6" onChange={(event) => { handleOnChange(event); }}
          type="text" 
          className="m-1 text-center form-control rounded" 
              maxLength={1} />
          </div>
          <div>
            <small>
              ...
              <a onClick={() => resendOTP()} style={{ color: '#3366FF' }} className="text-decoration-none ml-2">
                Gửi lại
              </a>
            </small>
          </div>
