      ...
      <Switch>
        <div className="App">
          ...
          <Route
            ...
            render={() => {
              if (
                ...
                (JSON.parse(localStorage.getItem('userData')).roleId === 'R1' || JSON.parse(localStorage.getItem('userData')).roleId === 'R4')
              ) {
          ...
          <Route
            path="/user/"
            render={() => {
              return JSON.parse(localStorage.getItem('userData')) && JSON.parse(localStorage.getItem('userData')) ? (
                <div>
                  <Header />
                  <UserHomePage />
                  <Footer />
