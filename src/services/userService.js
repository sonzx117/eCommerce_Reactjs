...
const handleGoogleLoginService = (data) => { 
...
export {
    ...
    createAllCodeService, getDetailAllcodeById, UpdateAllcodeService, DeleteAllcodeService, handleLoginService,handleGoogleLoginService,
